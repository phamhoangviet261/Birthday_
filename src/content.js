export default [
  ...
  "Anh được gặp em",
  "là cô gái khiến anh",
  "phải bỏ giấc ngủ trưa",
  "để đượcnói chuyện cùng",
  "Em là cô gái",
  "khiến anh thổn thức bao đêm",
  "người khiến cho anh",
  "vừa vui vì nói chuyện",
  "mà còn cảm thấy rất hợp",
  "hợp ở cả tính cách",
  "và cả suy nghĩ nữa",
  "Sau đó là chuỗi ngày",
  "đến đi ẻ mình cũng kể nhau",
  "♥",
  "Mãi tới ngày 22/6",
  "em mới chính thức",
  "mở cửa trái tim",
  ...
  "♥",
  "Đà Lạt chứa biết bao kỷ niệm",
  "Lần đầu gặp nhau",
  "biết bao bỡ ngợ",
  "cơ mà hông sợ",
  "vì anh yêu em ♥",
  "Và cả những lần đầu khác",
  "Anh trân trọng tất cả từ em",
  "♥",
  "Kỷ niệm 1 năm quen nhau",
  "anh hẹn bé ở Hà Nội",
  "để nhà mình được đoàn tụ",
  "Yêu bé rất nhiều",
  "Shiro ♥ Scarlet",
  "To be continued...",
  "♥♥♥♥♥♥♥♥♥",
